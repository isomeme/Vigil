...
fun TopLevelScreen() {
  ...
  PermissionGate(
    ...
    grantButtonLabel = stringResource(R.string.allow_notifications),
    rationaleTitle = stringResource(R.string.notifications_permission_required),
    rationaleDescription = stringResource(R.string.notification_permission_rationale),
    useSettingsTitle = stringResource(R.string.notifications_permission_required),
